...
<!-- Mirrored from 192.185.228.226/projects/sa/1-0-3/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2014 12:33:15 GMT -->
<head>
    ...
    <link href="style/css/calendar.css" rel="stylesheet">
    <link href="style/css/style.css" rel="stylesheet">
    <link href="style/css/icons.css" rel="stylesheet">
    <link href="style/css/generics.css" rel="stylesheet">
    <?php
...
<header id="header" class="media">
    ...
    <a class="logo pull-left" href="index.php">NIKKO Framework 2.01</a>
...
<aside id="sidebar">
    ...
    <ul class="list-unstyled side-menu">
        ...
        <?php
        if(
            ($acl->isAdministrator($_SESSION['CID']) && $acl->checkPermission($_SESSION['CID'], 'users', 'full|view|delete|update|insert')) || $acl->isSuperAdmin($_SESSION['CID'])) {
        ?>
        <li>
            <a class="sa-side-typography" href="index.php?control=main&action=user">
...
<!-- jQuery -->
<script src="style/js/jquery.min.js"></script> <!-- jQuery Library -->
<script src="style/js/jquery-ui.min.js"></script> <!-- jQuery UI -->
<script src="style/js/jquery.easing.1.3.js"></script> <!-- jQuery Easing - Requirred for Lightbox + Pie Charts-->

<!-- Bootstrap -->
<script src="style/js/bootstrap.min.js"></script>

<!-- Charts -->
<script src="style/js/charts/jquery.flot.js"></script> <!-- Flot Main -->
<script src="style/js/charts/jquery.flot.time.js"></script> <!-- Flot sub -->
<script src="style/js/charts/jquery.flot.animator.min.js"></script> <!-- Flot sub -->
<script src="style/js/charts/jquery.flot.resize.min.js"></script> <!-- Flot sub - for repaint when resizing the screen -->

<script src="style/js/sparkline.min.js"></script> <!-- Sparkline - Tiny charts -->
<script src="style/js/easypiechart.js"></script> <!-- EasyPieChart - Animated Pie Charts -->
<script src="style/js/charts.js"></script> <!-- All the above chart related functions -->

<!-- Map -->
<script src="style/js/maps/jvectormap.min.js"></script> <!-- jVectorMap main library -->
<script src="style/js/maps/usa.js"></script> <!-- USA Map for jVectorMap -->

<!--  Form Related -->
<script src="style/js/icheck.js"></script> <!-- Custom Checkbox + Radio -->

<!-- UX -->
<script src="style/js/scroll.min.js"></script> <!-- Custom Scrollbar -->

<!-- Other -->
<script src="style/js/calendar.min.js"></script> <!-- Calendar -->
<script src="style/js/feeds.min.js"></script> <!-- News Feeds -->
...
<!-- Mirrored from 192.185.228.226/projects/sa/1-0-3/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Nov 2014 12:34:21 GMT -->
</html>
